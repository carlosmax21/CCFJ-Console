      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= base_url('admin/dashboard'); ?>">APP RENTAL KONSOL</a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?= base_url('admin/data_konsol'); ?>"><i class="fas fa-gamepad"></i> <span>Data Konsol</span></a></li>
